param(
    [string]$ContentFile = 'scanner-support-manual.content.ps1',
    [string]$OutputPrefix = 'Yakult_Scanner_IT_Support_Manual',
    [string]$ImageSource = 'C:\Users\ITD\Desktop\Yakult-inventory-monitoring-system-User-manual-main\YS_NEW IMAGES'
)
