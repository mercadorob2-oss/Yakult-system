...
{
    public partial class AuthorizationMonitorView : UserControl
    {
        private readonly AuthorizationMonitorViewModel _vm;

        public AuthorizationMonitorView()
        {
            InitializeComponent();
            _vm        = new AuthorizationMonitorViewModel();
            DataContext = _vm;
            Loaded     += OnLoaded;
        }
        ...
        private async void BtnRefresh_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.LogError("AuthorizationMonitorView.BtnRefresh_Click failed", ex);
            }
        }
