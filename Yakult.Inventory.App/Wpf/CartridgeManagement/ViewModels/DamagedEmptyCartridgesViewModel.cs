...
{
    public class DamagedEmptyCartridgesViewModel : ViewModelBase
    {
        private const int PageSize = 20;
        private readonly CartridgeRefillService _service;

        private List<DamagedEmptyCartridgeDto> _all      = new List<DamagedEmptyCartridgeDto>();
        private List<DamagedEmptyCartridgeDto> _filtered = new List<DamagedEmptyCartridgeDto>();
        ...
        public ObservableCollection<DamagedEmptyCartridgeDto> PagedRows { get; }
            = new ObservableCollection<DamagedEmptyCartridgeDto>();

        public DamagedEmptyCartridgesViewModel()
        {
        ...
        public async Task LoadAsync()
        {
            ...
            try
            {
                _all = await _service.GetDamagedEmptiesAsync();
            ...
            {
                Logger.LogError("DamagedEmptyCartridgesViewModel.LoadAsync failed", ex);
                throw;
            }
            finally
            {
