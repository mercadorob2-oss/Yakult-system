...
{
    public class PartiallyFulfilledRequestsViewModel : ViewModelBase, IDisposable
    {
        ...
        private enum CardSortMode { Default, ByTotalIssuedDesc, ByTotalPendingDesc }
        private CardSortMode _cardSortMode = CardSortMode.Default;

        public bool IsSetsCardActive => _cardSortMode == CardSortMode.Default;
        public bool IsTotalIssuedCardActive => _cardSortMode == CardSortMode.ByTotalIssuedDesc;
        public bool IsTotalPendingCardActive => _cardSortMode == CardSortMode.ByTotalPendingDesc;

        public ICommand SetsCardCommand { get; }
        public ICommand TotalIssuedCardCommand { get; }
        public ICommand TotalPendingCardCommand { get; }

        private void SetCardSortMode(CardSortMode mode)
        {
            _cardSortMode = mode;
            OnPropertyChanged(nameof(IsSetsCardActive));
            OnPropertyChanged(nameof(IsTotalIssuedCardActive));
            OnPropertyChanged(nameof(IsTotalPendingCardActive));
            ApplyFilter();
        }
        ...
        public int SessionCount { get => _sessionCount; set => SetField(ref _sessionCount, value); }
        public int TotalIssued  { get => _totalIssued;  set => SetField(ref _totalIssued, value); }
        public int TotalPending { get => _totalPending; set => SetField(ref _totalPending, value); }
        ...
        public PartiallyFulfilledRequestsViewModel()
        {
            ...
            SetsCardCommand         = new RelayCommand(() => SetCardSortMode(CardSortMode.Default));
            TotalIssuedCardCommand  = new RelayCommand(() => SetCardSortMode(
                _cardSortMode == CardSortMode.ByTotalIssuedDesc ? CardSortMode.Default : CardSortMode.ByTotalIssuedDesc));
            TotalPendingCardCommand = new RelayCommand(() => SetCardSortMode(
                _cardSortMode == CardSortMode.ByTotalPendingDesc ? CardSortMode.Default : CardSortMode.ByTotalPendingDesc));
        ...
        public void LoadData()
        {
            try
            {
                ...
                _allRequests = _repository.GetPartiallyFulfilledRequestsFullSet(
        ...
        private void ApplyFilter()
        {
            ...
            _filteredSessions = _cardSortMode == CardSortMode.ByTotalIssuedDesc
                ? _filteredSessions.OrderByDescending(s => s.TotalIssued).ToList()
                : _cardSortMode == CardSortMode.ByTotalPendingDesc
