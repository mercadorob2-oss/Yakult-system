...
{
    /// <summary>
    /// Code-behind for UnfulfilledRequestsView.
    /// Handles VM wiring, filter/sort ComboBox two-way sync, DataGrid row-click
    /// bubbling, and the fulfill dialog launch.
    /// </summary>
    public partial class UnfulfilledRequestsView : UserControl
    {
        private UnfulfilledRequestsViewModel _vm;

        public UnfulfilledRequestsView()
        {
            InitializeComponent();

            _vm = new UnfulfilledRequestsViewModel();
            DataContext = _vm;
