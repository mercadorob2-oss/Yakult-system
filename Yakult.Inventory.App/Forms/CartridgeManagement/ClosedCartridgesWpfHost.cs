...
{
    public class ClosedCartridgesWpfHost : UserControl
    {
        private ElementHost          _host;
        private ClosedCartridgesView _view;
        private bool                 _disposed;

        public ClosedCartridgesWpfHost(string status)
        {
            Dock      = DockStyle.Fill;
            BackColor = Color.FromArgb(240, 242, 246);

            _view = new ClosedCartridgesView(status);
