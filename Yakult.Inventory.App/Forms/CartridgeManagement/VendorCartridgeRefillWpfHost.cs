...
{
    public class VendorCartridgeRefillWpfHost : UserControl
    {
        private ElementHost              _host;
        private VendorCartridgeRefillView _view;
        private bool                     _disposed;

        public VendorCartridgeRefillWpfHost()
        {
            Dock      = DockStyle.Fill;
            BackColor = Color.FromArgb(240, 242, 246);

            _view = new VendorCartridgeRefillView();
