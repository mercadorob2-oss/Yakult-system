...
{
    public class FulfilledCartridgesWpfHost : UserControl
    {
        private ElementHost              _host;
        private FulfilledCartridgesView  _view;
        private bool                     _disposed;

        public FulfilledCartridgesWpfHost()
        {
            Dock      = DockStyle.Fill;
            BackColor = Color.FromArgb(240, 242, 246);

            _view = new FulfilledCartridgesView();
