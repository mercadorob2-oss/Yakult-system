...
{
    public class DamagedEmptyCartridgesWpfHost : UserControl
    {
        private ElementHost                  _host;
        private DamagedEmptyCartridgesView   _view;
        private bool                         _disposed;

        public DamagedEmptyCartridgesWpfHost()
        {
            Dock      = DockStyle.Fill;
            BackColor = Color.FromArgb(240, 242, 246);

            _view = new DamagedEmptyCartridgesView();
