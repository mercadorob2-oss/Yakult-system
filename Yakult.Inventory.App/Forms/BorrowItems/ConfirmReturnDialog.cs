...
{
    public sealed class ConfirmReturnDialog : Form
    {
        public sealed class ReturnConfirmationModel
        {
        ...
        private readonly ReturnConfirmationModel _model;

        public ConfirmReturnDialog(ReturnConfirmationModel model)
        {
        ...
        private void InitializeComponent()
        {
            ...
            AddRow(summaryGrid, "Borrowed At", _model.BorrowedAt);
            AddRow(summaryGrid, "Returned By", _model.ReturnedBy);
            AddRow(summaryGrid, "Department", _model.Department);
            AddRow(summaryGrid, "Encoded By", _model.EncodedBy);
            AddRow(summaryGrid, "Date/Time", _model.Timestamp);
            ...
            var btnConfirm = ModernUiHelper.CreatePrimaryButton("Confirm return", width: 130);
        ...
        private void ApplyTheme()
        {
            ...
            var confirmButton = AcceptButton as Button;
            if (confirmButton != null)
                BorrowUiTheme.ApplyButton(confirmButton, BorrowButtonKind.Success);
