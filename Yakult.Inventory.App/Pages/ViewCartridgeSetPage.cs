...
namespace Yakult.Inventory.App.Pages
{
    public partial class ViewCartridgeSetPage : UserControl
    {
        ...
        private ReaLTaiizor.Controls.MaterialCard _cardExpired;
        private ReaLTaiizor.Controls.MaterialCard _cardWithQr;
        ...
        private Label _lblExpiredCount;
        private Label _lblWithQrCount;
        ...
        private void BuildUi()
        {
            ...
            _cardExpired = UiFactory.CreateSummaryCard("Expired", out _lblExpiredCount, UiTheme.Colors.Danger);
            _cardWithQr = UiFactory.CreateSummaryCard("With QR", out _lblWithQrCount, Color.FromArgb(46, 204, 113));
            ...
            DefaultListPageTemplate.AddSummaryCards(_layout.SummaryFlow, new[] { _cardTotal, _cardExpired, _cardWithQr });
            ...
            DefaultListPageTemplate.AttachVendorsPillCellPainting(dgvSets, c =>
            {
                ...
                return c.DataPropertyName == "ItemCount"
                    || c.DataPropertyName == "DaysLeft"
                    || c.DataPropertyName == "CreatedAt"
                    || c.DataPropertyName == "EffectiveExpiry"
            ...
            {
                Name = "EndDate",
                DataPropertyName = "EffectiveExpiry",
                HeaderText = "Expiry",
                FillWeight = 10,
                MinimumWidth = 110,
            ...
            {
                Name = "QRImagePath",
                DataPropertyName = "QRImageDisplay",
                HeaderText = "QR Image",
                FillWeight = 14,
                MinimumWidth = 150
            });
        ...
        private void UpdateSummaryCards()
        {
            ...
            int expired = data.Count(s => s != null && s.EffectiveExpiry.Date < today);
            int withQr = data.Count(s => s != null && s.HasQrImage);
            ...
            _lblExpiredCount.Text = expired.ToString();
            _lblWithQrCount.Text = withQr.ToString();
        ...
        private async Task UpgradeSetAsync(SetDto setDto)
        {
            try
            {
                using (var upgradeDialog = new Form())
                {
                    ...
                    {
                        var newStart = dtpStart.Value.Date;
                        var newEnd = dtpEnd.Value.Date;
        ...
        private void DgvSets_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            bool isCenteredDataColumn =
                ...
                column.DataPropertyName == "DaysLeft" ||
                column.DataPropertyName == "CreatedAt" ||
                column.DataPropertyName == "EffectiveExpiry" ||
