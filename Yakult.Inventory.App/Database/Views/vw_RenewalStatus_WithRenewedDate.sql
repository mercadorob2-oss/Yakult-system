-- =====================================================
-- Updated Renewal Status View with RenewedDate
-- Shows all Software/License and Service items with renewal tracking
-- Now includes RenewedDate from Renewals table
-- =====================================================
...
SELECT
    ...
    -- Renewed Date (get the most recent RenewedDate from Renewals table for items in this set)
...
SELECT TOP 10
    ...
    StartDate, EndDate, RenewedDate, DaysUntilExpiry, ExpiryStatus, ItemCount
...
PRINT 'Now includes RenewedDate from Renewals table';
PRINT '============================================';
GO
