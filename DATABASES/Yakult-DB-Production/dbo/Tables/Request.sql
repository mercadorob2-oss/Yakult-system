CREATE TABLE [dbo].[Request] (
    ...
    CONSTRAINT [FK_Request_Company] FOREIGN KEY ([ComId]) REFERENCES [dbo].[Company] ([ComId]),
    CONSTRAINT [FK_Request_Department] FOREIGN KEY ([DeptId]) REFERENCES [dbo].[Department] ([DeptId]),
    CONSTRAINT [FK_Request_Branch] FOREIGN KEY ([BranchId]) REFERENCES [dbo].[Branch] ([BranchId]),
    ...
    CONSTRAINT [FK_Request_ReceivedBy] FOREIGN KEY ([ReceivedById]) REFERENCES [dbo].[Employee] ([EmpId]),
...
GO
CREATE NONCLUSTERED INDEX [IX_Request_SetId_ReqId]
    ON [dbo].[Request]([SetId] ASC, [ReqId] ASC)
    INCLUDE([EmpId]);
