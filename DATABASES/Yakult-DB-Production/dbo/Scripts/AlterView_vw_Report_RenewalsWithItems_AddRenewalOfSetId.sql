-- ==========================================================================
-- MIGRATION: Expose RenewalOfSetId on vw_Report_RenewalsWithItems
-- PURPOSE: The flat Renewals Report needs to tell "original" sets apart
--          from "renewed" sets when a report is generated for a selected
--          renewal that has a parent set in its chain. RenewalOfSetId was
--          already used internally by the view's CROSS APPLY but was never
--          exposed in the SELECT list.
