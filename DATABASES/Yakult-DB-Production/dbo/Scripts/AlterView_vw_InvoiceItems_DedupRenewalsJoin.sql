-- Fixes vw_InvoiceItems duplicating invoice line rows for an Item that has more than one
-- non-archived Renewals row (e.g. renewed more than once via the Renew Items feature).
