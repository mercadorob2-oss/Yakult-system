-- ==========================================================================
-- SCRIPT: AlterView_vw_Report_RenewalGroupsLatest_AddFinancialFields.sql
-- PURPOSE: Adds Subtotal, VatAmount, WhtAmount, DiscountAmount columns
--          from dbo.[Set] to support the Renewals (Grouped) Report summary
--          rows (Subtotal / VAT / WHT / Discount / Total Amount footer per set).
-- DATE:    2026-03-23
-- ==========================================================================
