-- Migration: Extend sp_RepairPortal_CreateTicket with @RequestedByType/@RequestedByDeptId/
-- @RequestedByEmpId (new optional params, defaulted so any other caller is unaffected).
