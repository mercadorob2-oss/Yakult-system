...
CREATE OR ALTER PROCEDURE [dbo].[usp_AssignBranchDeptCompany]
    @BranchID     INT,
    @CompanyID    INT,
...
-- Assign Branch 5 to Company 2, Department 12 (normal case):
-- EXEC dbo.usp_AssignBranchDeptCompany
--     @BranchID = 5, @CompanyID = 2, @DepartmentID = 12,
--     @BranchEmail = 'branch@yakult.com';

-- Assign Branch 7 to Company 3, NO department (YMC case):
-- EXEC dbo.usp_AssignBranchDeptCompany
--     @BranchID = 7, @CompanyID = 3, @DepartmentID = NULL,
--     @BranchEmail = NULL;
