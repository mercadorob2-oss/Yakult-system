-- Adds InvoiceSubType (from dbo.[Set]) and InvoiceGroupNum (from dbo.InvoiceGroup) to
-- vw_InvoiceItems, in both halves of the UNION ALL. Run after
-- Migration_InvoiceGroup_CreateTable.sql and Migration_Set_AddInvoiceGroupAndSubType.sql.
