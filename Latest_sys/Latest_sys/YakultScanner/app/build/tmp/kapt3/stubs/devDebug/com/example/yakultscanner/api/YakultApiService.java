...
public abstract interface YakultApiService {
    ...
    @retrofit2.http.GET(value = "repair-ticket-lookup.ashx")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object lookupRepairTicket(@retrofit2.http.Query(value = "ticketCode")
    @org.jetbrains.annotations.Nullable()
    java.lang.String ticketCode, @retrofit2.http.Query(value = "token")
    @org.jetbrains.annotations.Nullable()
    java.lang.String token, @org.jetbrains.annotations.NotNull()
    ...
    @retrofit2.http.POST(value = "repair-part-photo-upload.ashx")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object uploadRepairPartPhoto(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.Nullable()
    java.lang.String status, @retrofit2.http.Query(value = "scope")
    @org.jetbrains.annotations.Nullable()
    java.lang.String scope, @retrofit2.http.Query(value = "search")
    @org.jetbrains.annotations.Nullable()
